...
import Resize, {
    ...
    updateColumnWidth,
} from "Magento_PageBuilder/js/content-type/column/resize";
import PreviewCollection from "Magento_PageBuilder/js/content-type/preview-collection";
import {calculateDropPositions, DropPosition} from "Magento_PageBuilder/js/content-type/column-line/drag-and-drop";
...
export default class Preview extends PreviewCollection {
    ...
    protected dropPlaceholder: JQuery;
    protected movePlaceholder: any;
    protected dropPositions: DropPosition[] = [];
    protected dropPosition: DropPosition;
    protected startDragEvent: JQueryEventObject;
    protected movePosition: DropPosition;
    protected dropOverElement: boolean;
    protected resizeUtils: Resize;
    protected linePositionCache: LinePositionCache;
    protected columnLineDropPlaceholder: JQuery;
    protected resizeColumnInstance: ContentTypeCollectionInterface<ColumnPreview>;
    protected resizeColumnWidths: ColumnWidth[];
    protected resizeMaxGhostWidth: MaxGhostWidth;
    protected resizeHistory: ResizeHistory = {
        left: [],
        right: [],
    };
    protected resizeLastPosition: number;
    protected resizeLastColumnInPair: string;
    protected resizeMouseDown: boolean;
    protected interactionLevel: number = 0;
    protected lineDropperHeight: number = 50;
    protected resizeGhost: JQuery;
    protected resizeLeftLastColumnShrunk: ContentTypeCollectionInterface<ColumnPreview>;
    protected resizeRightLastColumnShrunk: ContentTypeCollectionInterface<ColumnPreview>;
    protected columnLineBottomDropPlaceholder: JQuery;
     ...
     */
    protected onNewColumnDrop(dropPosition: DropPosition) {
     ...
     */
    protected onExistingColumnDrop(movePosition: DropPosition) {
     ...
     * @param {JQuery} line
     */
    protected initMouseMove(line: JQuery): void {
     ...
     */
    protected endAllInteractions(): void {
     ...
     * @returns {boolean}
     */
    protected eventIntersectsLine(event: JQueryEventObject, groupPosition: LinePositionCache): boolean {
     ...
     */
    protected onDraggingMouseMove(event: JQueryEventObject, line: JQuery, linePosition: LinePositionCache): void {
        const dragColumn = getDragColumn();
        if (dragColumn) {
     ...
     */
    protected onResizingMouseMove(event: JQueryEventObject, group: JQuery, groupPosition: GroupPositionCache): void {
     ...
     */
    protected unsetResizingColumns(): void {
     ...
     * @private
     */
    protected isNewLinePlaceDropPlaceholderVisible(event: JQueryEventObject, linePosition: LinePositionCache): boolean {
     ...
     * @private
     */
    protected isNewLineBottomPlaceDropPlaceholderVisible(
     ...
     * @private
     */
    protected isNewColumnDropPlaceholderVisible(event: JQueryEventObject, linePosition: LinePositionCache): boolean {
     ...
     * @param {LinePositionCache} linePosition
     */
    protected onDroppingMouseMove(event: JQueryEventObject, line: JQuery, linePosition: LinePositionCache): void {
     ...
     * @private
     */
    protected handleLineDropMouseMove(event: JQueryEventObject, line: JQuery, linePosition: LinePositionCache): void {
        const elementChildrenParent = line.parents(".element-children");
     ...
     * @private
     */
    protected handleColumnDropMouseMove(event: JQueryEventObject, line: JQuery, linePosition: LinePositionCache): void {
        const elementChildrenParent = line.parents(".element-children");
        // Only initiate this process if we're within the group by a buffer to allow for sortable to function correctly
        if (
     ...
     * @param {JQuery} line
     */
    protected initDroppable(line: JQuery): void {
        const self = this;
     ...
     */
    protected spreadWidth(removedIndex: number): void {
     ...
     * @param {JQuery} handle
     */
    protected registerResizeHandle(column: ContentTypeCollectionInterface<ColumnPreview>, handle: JQuery) {
     ...
     */
    protected setColumnsAsResizing(...columns: Array<ContentTypeCollectionInterface<ColumnPreview>>): void {
     ...
     */
    protected fireMountEvent(...contentTypes: ContentTypeInterface[]) {
    ...
    protected isColumnBeingMovedToAnotherColumnLine(): boolean {
        const column = getDragColumn();
        if (!column) {
